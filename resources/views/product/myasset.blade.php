        ...
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <div class="col-6">
                        <h3 class="modal-title" id="modal-title-default">Detail Assset</h3>
                    </div>
                ...
                <div class="modal-footer tombolnya2">
                    <table width="100%">
                        <tr>
                            <td>
                                <button type="button" id="kembalikan" class="btn btn-warning btn-block ml-auto"
                                    data-dismiss="modal">Kembalikan</button>
                            </td>
                            {{-- <td width="5%">
                                &nbsp;
                            </td> --}}
...
@push('scripts')
    <script type="text/javascript">
        ...
        function Lihat(id) {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    $('#kembalikan').attr('onclick', 'Kembalikan("' + response.product.id + '")');
                }
            });
        ...
        function Kembalikan(id) {
            $.ajax({
                type: 'POST',
                url: "{{ route('transaction.kembalikan') }}",
                data: {
                    '_token': $('input[name=_token]').val(),
                    'id': id,
                },
                success: function(response) {
                    if (response.status == 'success') {
                        ...
                        Swal.fire({
                            title: "Berhasil!",
                            text: "Asset Berhasil di Kembalikan!",
                            icon: "success"
                        });
                    }
                }
