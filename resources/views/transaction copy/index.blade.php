        ...
        <div class="modal-dialog modal-md modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <div class="col-6">
                        <h3 class="modal-title" id="modal-title-default">Detail Pengajuan</h3>
                    </div>
                ...
                <div class="modal-footer tombolnya2">
                    <table width="100%">
                        <tr>
                            <td>
                                <button type="button" id="approve" class="btn btn-success btn-block ml-auto"
                            ...
                            <td>
                                <button type="button" id="tolak" class="btn btn-danger btn-block ml-auto"
                        ...
                        render: function(data, type, row) {
                            ...
                            if (row.status == 'pengajuan') {
                                return '<div style="text-align: right;">' +
                                    ...
                                    row
                                    .id +
                                    ')">Lihat <i class="fa fa-eye"></i></button></div>';
                            }
                        }
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 'success') {
                        ...
                        Swal.fire({
                            title: "Berhasil!",
                            text: "Pengajuan Berhasil di Approve!",
                            icon: "success"
                        });
                    }
                }
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.status == 'success') {
                        ...
                        Swal.fire({
                            title: "Berhasil!",
                            text: "Pengajuan Berhasil di Tolak!",
                            icon: "success"
                        });
                    }
                }
