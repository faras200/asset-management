                    ...
                    <div class="card-header bg-transparent">
                        <div class="row align-items-center">
                            <div class="col">
                                ...
                                <h2 class=" mb-0">Kategori Asset</h2>
                            </div>
                            <div class="col">
                                <ul class="nav nav-pills justify-content-end">
                                    <li class="nav-item mr-2 mr-md-0" data-toggle="chart" data-target="#chart-sales"
                                        ...
                                        <a href="/product-category/create" class="nav-link py-2 px-3 active">
                    ...
                    },
                    {
                        render: function(data, type, row) {
                            return '<div style="text-align: right;">' +
                                ...
                                '<form class="d-inline" action="/product-category/' + row.id +
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/andysuryawan/Documents/warungkoki/asset-management/resources/views/product_category/index.blade.php ENDPATH**/ ?>